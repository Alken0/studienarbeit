from keras import models, Sequential, layers, initializers
...
sys.path.append(".")
from constants import NUM_CLASSES, IMG_DIM, LATENT_DIM

def make_generator_model() -> models.Model:
