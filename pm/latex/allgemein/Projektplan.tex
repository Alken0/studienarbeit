...
\begin{center}
	\makebox[\textwidth]{\includegraphics[width=1.0\textwidth]{allgemein/projektplan/Projektplan1.png}}
\end{center}
\begin{center}
	\makebox[\textwidth]{\includegraphics[width=1.0\textwidth]{allgemein/projektplan/Projektplan2.png}}
\end{center}
