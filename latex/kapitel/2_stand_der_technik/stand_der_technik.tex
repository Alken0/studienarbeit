...
$32$ und $64$ wird in Papers oder Tutorials häufig als ein guter Standartwert angegeben \cite{default-batch-size}. \todo{64 auch? (nur hinzugefügt, damit wir die Zahl unten referenzieren können)}
...
\section{Datensätze}
\todo[inline, shadow]{\cite{dataset:four-shapes, dataset:2d-geometric-shapes-dataset} erklären}
